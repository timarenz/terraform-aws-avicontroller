resource "aws_iam_role" "avicontroller" {
  name_prefix         = "${var.owner_name}-${var.environment_name}-avi-"
...
resource "aws_iam_role_policy" "avicontroller_policy" {
  name_prefix = "${var.owner_name}-${var.environment_name}-avi-policy"
